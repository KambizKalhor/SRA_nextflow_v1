process SECOND_QC {
    ...
    mkdir -p ${sample_id}
    fastqc -t $SLURM_CPUS_PER_TASK -o ${sample_id}/ ${params.trimmomatic_results}/${sample_id}/${sample_id}_TRIMMED_FORWARD_PAIRED_R1.fastq ${params.trimmomatic_results}/${sample_id}/${sample_id}_TRIMMED_REVERSE_PAIRED_R2.fastq
    """
}
