process METASPADES {
    ...
    spades.py --meta --threads $task.cpus --memory 1000 --pe1-1 ${params.trimmomatic_results}/${sample_id}/${sample_id}_TRIMMED_FORWARD_PAIRED_R1.fastq --pe1-2 ${params.trimmomatic_results}/${sample_id}/${sample_id}_TRIMMED_REVERSE_PAIRED_R2.fastq -o ${sample_id}/
    """
}
